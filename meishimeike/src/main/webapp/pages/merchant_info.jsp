...
<html>
	...
	<body>
		<div id="top1">
			<header>
				<nav class="navbar navbar-default" role="navigation">
					<div id="bodys" class="container-fluid">
						<div class="navbar-header"> <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#example-navbar-collapse">
						...
						<div class="collapse navbar-collapse" id="example-navbar-collapse">
							<ul class="nav navbar-nav">
								...
								<li>
									<a href="/meishimeike/pages/merchant_login.html">入住加盟</a>
								</li>
								<li>
									<c:if test="${user==null}">
								...
								<c:if test="${user!=null}">
									<li>
										<a style="color: #b34644;" href="/meishimeike/pages/user_login.html">注销</a>
									</li>
								</c:if>
								<li class="dropdown">
			...
			<div style="clear: both; margin-top: 30px;" class="cent"> <img src="img/${merchantData.info.mLogo}" align="top" class="float_left" width="80" height="80" style="border-radius: 90px; box-shadow: 0px 0px 10px 5px #aaa;" />
				<div style="width: 20%; line-height: 20px; padding-top: 10px; padding-left: 20px;" class="float_left"> <span style="color: #FFF; font-size: 20px;"> ${merchantData.info.mName}</span><br> <br> <span style="color: #cccc33;">★★★★★</span> </div>
				<div class="float_r" id="float_r">
					<table style="width: 100%; height: 80%; color: #fff;" border="0" class="tab">
						<tr>
							<td>起送价</td>
							<td>配送费</td>
							<td>平均送达速度</td>
		...
		<div id="cent">
			<div id="cent_main">
				<div style="width: 50%; box-sizing: border-box; padding-top: 13px;" class="float_left" id="float_lefts">
					<ul>
						<li class="float_left"><span style="border-right: 1px solid Gainsboro; color: rgba(30, 173, 250, 1);">所有商品</span></li>
						<li class="float_left"><span style="border-right: 1px solid Gainsboro;">评价</span></li>
				...
				<div class="float_left" id="float_leftss">
					<ul>
						...
						<li class="float_r" id="clear_float_r" style="color: rgba(30, 173, 250, 1);">默认排序</li>
					</ul>
				</div>
			</div>
		</div>
							...
							<div class="mu_lu_box_c">
								...
								<c:forEach var="j" items="${merchantData.commodity}">
									<c:if test="${i.cId==j.cId}">
										<div id="float_left_boxs_s" class="float_left boxs"> <img class="float_left" src="img/${j.cyImg}" align="top" />
											<div class="float_left" style="width: 60%; padding-left: 15px;"> <span>${j.cyName }</span> <br /> <span><input
												type="button" class="float_r btnsty delete"
												onclick="add_info(this,${j.cyId})" style="margin-top: 9px;"
												value="加入购物车" /> </span>
												<p style="overflow: hidden; white-space: nowrap; text-overflow: ellipsis; font-size: 13px; color: darkgray;">${j.cyRemark}</p> <span><p style="margin-top: 3px; color: #cccc33;">★★★★★</span><br /> <span style="color: red">￥</span><span class="price" style="color:red"> ${j.cPrice }</span> </div>
										</div>
										<c:set var="bool" value="false" /> </c:if>
								</c:forEach>
								<c:if test="${bool}">
			...
			<div id="bottom">
				...
				<div class="bot_main">
					<div style="width: 50%;" class="bot_r">
						<p> 24小时客服热线 : 10105757 <br />
							<p style="margin-top: 10px; color: darkgray;">关注我们 : 扫描二维码,体验手机版 </div>
					<div style="width: 50%;" class="bot_r">
						<div class="fola_l" style="width: 100%; text-align: center;"> <img src="img/erwei.png" width="110" height="110" align="middle" /> </div>
					</div>
				</div>
				<div style="clear: both;"></div>
				<div style="text-align: center; margin-top: 20px; font-size: 13px;"> 所有方 ：三联信息工程系14班</div>
				<div style="text-align: center; margin-top: 6px; font-size: 13px;">
					<a style="margin: auto; color: #C0C0C0;" href="http://www.miitbeian.gov.cn/">渝ICP备18005766号</a>
				</div>
			</div>
			<div id="gowuche_logo"> <img src="img/gowuche_logo.png" />
				<div>0</div>
			</div>
			<!-- -------------购物车--------------------- -->
			<div id="gouwuche">
				<div class="box tag" id="gouwu_top"> 购物车[<span style="color: #4CAF50;" onclick="location.reload()">清空</span>]
				...
				<div id="wai">
					<form action="/meishimeike/merchant/xiadan" id="from1" method="post">
						<div id="gou_main">
							<div class="box tag">
								<div style="width: 60%; background-color: #3c3c3c; color: darkgray; padding-left: 5px; box-sizing: border-box;" class="float_left"> <span id="sum" style="font-size: 20px; color: #fff;">￥0</span> &nbsp;配送费2 </div>
								<div style="width: 40%; background-color: #f3f3f3; text-align: center;" id="jie" class="float_left">购物是空的</div>
							</div>
						</div>
					</form>
				</div>
